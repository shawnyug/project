...
class LossOutput:
    ...
    contrastive_loss: LossRecord | None = None
    ...
    def __post_init__(self):
        ...
        self.contrastive_loss = self._as_dict("contrastive_loss")
        ...
        self.contrastive_loss_sum = self.dict_sum(self.contrastive_loss).sum()
